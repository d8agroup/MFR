...
class Ion_auth_model extends CI_Model
{
	 ...
	 * @author Mathew
	 **/
	public function register($username, $password, $email, $additional_data = array(), $groups = array(), $is_active = null)
	{
		...
		$data = array(
		    ...
		    'created_on' => time(),
		    'last_login' => time(),
		    'active'     => $is_active === null ? ($manual_activation === false ? 1 : 0) : $is_active,
		);
