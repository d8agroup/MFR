...
class Ion_auth
{
	 ...
	 * @author Mathew
	 **/
	public function register($username, $password, $email, $additional_data = array(), $group_ids = array(), $is_active = null) //need to test email activation
	{
		...
		if (!$email_activation)
		{
			$id = $this->ion_auth_model->register($username, $password, $email, $additional_data, $group_ids, $is_active);
			if ($id !== FALSE)
			{
    ...
    {
        return $this->ion_auth_model->get_users_groups(1);
    }
